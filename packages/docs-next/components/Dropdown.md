...
| appendToBody | Append dropdown content to body                                                                                                                                  | boolean                                | -                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;appendToBody: false<br>}</code>                       |
...
| closeable    | Can close dropdown by pressing escape, clicking the content or outside                                                                                           | string[] \| boolean                    | `escape`, `outside`, `content`                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;closeable: ["escape","outside","content"]<br>}</code> |
