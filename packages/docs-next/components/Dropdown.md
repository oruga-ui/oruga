...
| closeable    | Can close dropdown by pressing escape, clicking the content or outside                                                                                           | string[] \| boolean                    | `escape`, `outside`, `content`                                 | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>ropdown: {<br>&nbsp;&nbsp;closeable: ["escape"<br>}</code> |
