...
| position         | Sidebar position                                                                                                                                                                    | string                  | `top`, `right`, `bottom`, `left`                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>sidebar: {<br>&nbsp;&nbsp;position: undefined<br>}</code>              |
