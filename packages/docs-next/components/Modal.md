...
| cancelable    | Can close Modal by clicking 'X', pressing escape or clicking outside.                                                                                                               | string[] \| boolean | `escape`, `x`, `outside`, `button`, `true` | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>odal: {<br>&nbsp;&nbsp;cancelable: ["escape"<br>}</code>     |
