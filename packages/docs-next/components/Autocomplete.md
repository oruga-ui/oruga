...
| clearIcon            | Icon name to be added on the clear button                                                                                                              | string              | -                                                 | <div>From <b>config</b></div><br><code style='white-space: nowrap; padding: 0;'> autocomplete: {<br>&nbsp;&nbsp;clearIcon: 'close-circle'<br>}</code> |
...
| itemTag              | Menu item tag name                                                                                                                                     | string \| Component | -                                                 | <div>From <b>config</b></div><br><code style='white-space: nowrap; padding: 0;'> autocomplete: {<br>&nbsp;&nbsp;itemTag: 'div'<br>}</code>            |
...
| menuTag              | Menu tag name                                                                                                                                          | string \| Component | -                                                 | <div>From <b>config</b></div><br><code style='white-space: nowrap; padding: 0;'> autocomplete: {<br>&nbsp;&nbsp;menuTag: 'div'<br>}</code>            |
