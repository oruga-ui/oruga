  ...
  <section>
    ...
    >
      ...
      <o-table-column
        ...
        v-slot="props"
      >
        {{ props.row.release_date ? new
        Date(props.row.release_date).toLocaleDateString() : 'unknown' }}
      </o-table-column>
...
<template>
  <section>
    ...
    <o-table :data="data">
      <template #default v-for="column in columns" :key="column.id">
  ...
  export default {
    ...
    methods: {
      ...
      columndrop(payload) {
        ...
        this.$oruga.notification.open(
          `Moved ${this.draggingColumn.field} from column ${this
            .draggingColumnIndex + 1} to ${droppedOnColumnIndex + 1}`
        );
      }
    }
  };
