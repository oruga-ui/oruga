...
| ariaCloseLabel | Accessibility label for the close button                                                                           | string             | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>otification: {<br>&nbsp;&nbsp;ariaCloseLabel: "Close notification"<br>}</code> |
| closable       | Add close/delete button to the item that closes the notification                                                   | boolean            | -                                                                               | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                                |
...
| iconSize       | Icon size                                                                                                          | string             | `small`, `medium`, `large`                                                      | <code style='white-space: nowrap; padding: 0;'>"large"</code>                                                                                                              |
| message        | Message text (can contain HTML).                                                                                   | string \| string[] | -                                                                               |                                                                                                                                                                            |
...
| ------- | ---------------------------- | ------------------------------------------------------ |
| default | Notification default content | **close** `close` - function to close the notification |
