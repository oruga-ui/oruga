...
| position                  | Position of the popover relative to the input                                                                                                                                    | "bottom" \| "left" \| "right" \| "top"                                                                                    | `auto`, `top`, `bottom`, `left`, `right`, `top-right`, `top-left`, `bottom-left`, `bottom-right` | <code style='white-space: nowrap; padding: 0;'>"bottom"</code>                                                                                                            |
