...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| active                    | The active state of the picker, use v-model:active to make it two-way binding                                                                                                    | boolean                                                                                                                   | -                                                  | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                               |
...
| desktopModal              | Picker content is shown into a modal on desktop                                                                                                                                  | boolean                                                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;desktopModal: false<br>}</code>                  |
...
| iconRightVariant          | Variant of the right icon                                                                                                                                                        | string                                                                                                                    | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;iconRightVariant: undefined<br>}</code>          |
| iconSize                  | Size of the icon                                                                                                                                                                 | string                                                                                                                    | `small`, `medium`, `large`                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;iconSize: undefined<br>}</code>                  |
...
| mobileModal               | Picker content is shown into a modal on mobile                                                                                                                                   | boolean                                                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;mobileModal: true<br>}</code>                    |
| mobileNative              | Enable mobile native input if device is a mobile agent                                                                                                                           | boolean                                                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;mobileNative: false<br>}</code>                  |
...
| openOnFocus               | Open picker on focus                                                                                                                                                             | boolean                                                                                                                   | -                                                  | <code style='white-space: nowrap; padding: 0;'>true</code>                                                                                                                |
...
| position                  | Position of the popover relative to the input                                                                                                                                    | "bottom" \| "center" \| "left" \| "right" \| "top"                                                                        | `auto`, `top`, `bottom`, `left`, `right`, `center` | <code style='white-space: nowrap; padding: 0;'>"bottom"</code>                                                                                                            |
| range                     | Enable date range selection                                                                                                                                                      | IsRange                                                                                                                   | -                                                  |                                                                                                                                                                           |
...
| stayOpen                  | The picker stays open after date got picked                                                                                                                                      | boolean                                                                                                                   | -                                                  | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                               |
...
| header  | Override the content header                 |          |
...
| $datepicker-content-padding                             | h.useVar("control-spacer") calc(2 \* h.useVar("control-spacer"))             |
| $datepicker-content-box-shadow                          | 0 0.5em 1em -0.125em rgba(10, 10, 10, 0.1), 0 0 0 1px rgba(10, 10, 10, 0.02) |
| $datepicker-content-background-color                    | h.useVar( "control-background-color")                                        |
| $datepicker-content-border-color                        | h.useVar("control-border-color")                                             |
| $datepicker-content-border-style                        | solid                                                                        |
| $datepicker-content-border-width                        | h.useVar("control-border-width")                                             |
| $datepicker-content-border-radius                       | h.useVar("border-radius")                                                    |
| $datepicker-overlay-background-color                    | h.useVar( "overlay-background-color")                                        |
...
| $datepicker-table-cell-today-border                     | 1px solid h.useVar("primary")                                                |
...
| $datepicker-overlay-box-shadow                    | css.getVar("shadow")                                                                                |
| $datepicker-overlay-radius                        | css.getVar("radius")                                                                                |
| $datepicker-overlay-background-color              | hsla( #{css.getVar("scheme-h")}, #{css.getVar("scheme-s")}, #{css.getVar("scheme-invert-l")}, 0.86) |
...
| $datepicker-item-hover-within-background-color    | css.getVar( "grey-lighter")                                                                         |
| $datepicker-item-selected-color                   | css.getVar("primary-invert")                                                                        |
| $datepicker-item-selected-background-color        | css.getVar("primary")                                                                               |
| $datepicker-item-selected-within-background-color | css.getVar( "primary-85")                                                                           |
...
| SASS Variable                   | Default                                 |
| ------------------------------- | --------------------------------------- |
| $datepicker-overlay-bg          | var(--#{$prefix}body-bg)                |
| $datepicker-overlay-radius      | var(--#{$prefix}border-radius)          |
| $datepicker-overlay-box-shadow  | $box-shadow                             |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_datepicker.scss)
