...
<script setup>
import Base from "@/components/Datepicker/examples/base.vue";
import BaseCode from "@/components/Datepicker/examples/base.vue?raw";

import MinMaxDate from "@/components/Datepicker/examples/min-max-date.vue";
import MinMaxDateCode from "@/components/Datepicker/examples/min-max-date.vue?raw";

import Range from "@/components/Datepicker/examples/range.vue";
import RangeCode from "@/components/Datepicker/examples/range.vue?raw";

import Multiple from "@/components/Datepicker/examples/multiple.vue";
import MultipleCode from "@/components/Datepicker/examples/multiple.vue?raw";

import Programmatically from "@/components/Datepicker/examples/programmatically.vue";
import ProgrammaticallyCode from "@/components/Datepicker/examples/programmatically.vue?raw";

import Templates from "@/components/Datepicker/examples/templates.vue";
import TemplatesCode from "@/components/Datepicker/examples/templates.vue?raw";

import Events from "@/components/Datepicker/examples/events.vue";
import EventsCode from "@/components/Datepicker/examples/events.vue?raw";

import MonthPicker from "@/components/Datepicker/examples/month-picker.vue";
import MonthPickerCode from "@/components/Datepicker/examples/month-picker.vue?raw";
</script>
