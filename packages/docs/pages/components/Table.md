...
<script setup>
import Base from "@/components/Table/examples/base.vue";
import BaseCode from "@/components/Table/examples/base.vue?raw";

import Customise from "@/components/Table/examples/customise.vue";
import CustomiseCode from "@/components/Table/examples/customise.vue?raw";

import Columns from "@/components/Table/examples/columns.vue";
import ColumnsCode from "@/components/Table/examples/columns.vue?raw";

import Selection from "@/components/Table/examples/selection.vue";
import SelectionCode from "@/components/Table/examples/selection.vue?raw";

import Pagination from "@/components/Table/examples/pagination.vue";
import PaginationCode from "@/components/Table/examples/pagination.vue?raw";

import AsyncData from "@/components/Table/examples/async-data.vue";
import AsyncDataCode from "@/components/Table/examples/async-data.vue?raw";

import Checkable from "@/components/Table/examples/checkable.vue";
import CheckableCode from "@/components/Table/examples/checkable.vue?raw";

import Sticky from "@/components/Table/examples/sticky.vue";
import StickyCode from "@/components/Table/examples/sticky.vue?raw";

import Detailed from "@/components/Table/examples/detailed.vue";
import DetailedCode from "@/components/Table/examples/detailed.vue?raw";

import Filterable from "@/components/Table/examples/filterable.vue";
import FilterableCode from "@/components/Table/examples/filterable.vue?raw";

import Draggable from "@/components/Table/examples/draggable.vue";
import DraggableCode from "@/components/Table/examples/draggable.vue?raw";
</script>
...
| backendFiltering      | Columns won't be filtered on clientside, use with `filterable` prop to the columns to filter in your backend                                                                                       | boolean                                                           | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>table: {<br>&nbsp;&nbsp;backendFiltering: false<br>}</code>          |
...
| filterDebounce        | Debounce column filter input change events (in milliseconds)                                                                                                                                       | number                                                            | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>table: {<br>&nbsp;&nbsp;filterDebounce: 300<br>}</code>              |
| filterIcon            | Icon of the column filter inputs                                                                                                                                                                   | string                                                            | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>table: {<br>&nbsp;&nbsp;filterIcon: undefined<br>}</code>            |
| filterPlaceholder     | Placeholder of the column filter inputs                                                                                                                                                            | string                                                            | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>table: {<br>&nbsp;&nbsp;filterPlaceholder: undefined<br>}</code>     |
...
| keepChecked           | Controls whether checked rows are cleared when table pagination changes                                                                                                                            | boolean                                                           | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>table: {<br>&nbsp;&nbsp;keepChecked: false<br>}</code>               |
...
| field        | Define an object property key if data is an object                                                                                                                                               | K                                                                | -                           |                                                             |
...
| formatter    | Provide a formatter function to edit the output                                                                                                                                                  | ((value: DeepType&lt;unknown, K&gt;, row: unknown) =&gt; string) | -                           |                                                             |
...
| tdAttrs      | Adds native attributes to td.<br/><br/>_Due to a Vue reactivity system limitiation do not define an object value directly in the component template block - use a variable in the script block._ | object                                                           | -                           |                                                             |
| thAttrs      | Adds native attributes to th.<br/><br/>_Due to a Vue reactivity system limitiation do not define an object value directly in the component template block - use a variable in the script block._ | object                                                           | -                           |                                                             |
