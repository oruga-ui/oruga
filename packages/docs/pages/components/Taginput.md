...
The **Taginput** input component allows users to search through a list of options and apply them asa number of tags.
...
| closeIconSize      | Size of the close icon on selected item                                                                                                                                          | string                                                                                         | `small`, `medium`, `large`                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>taginput: {<br>&nbsp;&nbsp;closeIconSize: undefined<br>}</code> |
...
| createItem         | Function to create a new item to push into v-model (items)                                                                                                                       | ((value: string \| unknown) =&gt; unknown)                                                     | -                                                                               | <code style='white-space: nowrap; padding: 0;'>item</code>                                                                                                  |
...
| iconSize           | Size of the icon                                                                                                                                                                 | string                                                                                         | `small`, `medium`, `large`                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>taginput: {<br>&nbsp;&nbsp;iconSize: undefined<br>}</code>      |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_taginput.scss)
