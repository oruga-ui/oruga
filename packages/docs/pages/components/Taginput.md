...
The component is based on the and [Autocomplete](/components/Autocomplete) component and implements the W3C ARIA APG [Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/).
