...
| debounce           | Number of milliseconds to delay before the value get emitted                              | number                                                                                                         | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>autocomplete: {<br>&nbsp;&nbsp;debounce: undefined<br>}</code> |
...
| iconSize           | Size of the icon                                                                          | string                                                                                                         | `small`, `medium`, `large`                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>input: {<br>&nbsp;&nbsp;iconSize: undefined<br>}</code>        |
