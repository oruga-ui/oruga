...
| options   | Menu options, unnecessary when default slot is used                                                                                                              | MenuOptions&lt;unknown&gt; | -                                                 |                                                                                                                                                    |
...
| options   | Submenu options, unnecessary when default slot is used                                          | MenuOptions&lt;unknown&gt; | -                                                 |                                                                                                                                                     |
| override  | Override existing theme classes completely                                                      | boolean                    | -                                                 |                                                                                                                                                     |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_menu.scss)
