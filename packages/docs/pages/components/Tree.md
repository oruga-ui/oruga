...
| ariaLabelledby    | Accessibility aria-labelledby to associate a label element with this component      | string                                                | -                                                 |                                                                                                                                                            |
| backendFiltering  | Disable client-side filtering and rely on parent logic                              | boolean                                               | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                |
...
| filter            | Custom filter function to determine visibility                                      | ((value: unknown, filterValue: string) =&gt; boolean) | -                                                 |                                                                                                                                                            |
| filterDebounce    | Debounce delay for the filter input                                                 | number                                                | -                                                 | <code style='white-space: nowrap; padding: 0;'>400</code>                                                                                                  |
| filterIcon        | The icon to display in the filter input                                             | string                                                | -                                                 |                                                                                                                                                            |
| filterPlaceholder | Placeholder for the filter input                                                    | string                                                | -                                                 |                                                                                                                                                            |
| filterable        | Enables client-side filtering of tree items                                         | boolean                                               | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                |
...
| options           | Tree options, unnecessary when default slot is used                                 | TreeOptions&lt;unknown&gt;                            | -                                                 |                                                                                                                                                            |
...
| filter  | Override the filter input                       | **value** `string` - filter input value<br/>**onChange** `(input: string, event: Event): void` - on filter input change event<br/>**onKeydown** `(event: Event): void` - on filter input keydown event |
...
| options        | Subtree options, unnecessary when default slot is used                                    | TreeOptions&lt;unknown&gt; | -                                                 |                                                                                                                                                    |
| override       | Override existing theme classes completely                                                | boolean                    | -                                                 |                                                                                                                                                    |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_tree.scss)
