...
The **Carousel** component is a slideshow widget for cycling through a set of elements — images or texts — like a carousel, referred to as slides, by sequentially displaying a subset of one or more slides.
