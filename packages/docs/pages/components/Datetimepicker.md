...
The **Datetimepicker** input component allow users to select a date and time based on their browser’s locale from a customizable calendar, or to type the date directly into the input with full internationalization support.
The input opens a simple popover/modal for selecting a date, and uses the native datetimepicker for mobile.

The component is based on the [Datepicker](/components/Datepicker) and [Timepicker](/components/Timepicker) components.
...
| desktopModal       | Overlay content is shown into a modal on desktop                                                                                                                                 | boolean                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datetimepicker: {<br>&nbsp;&nbsp;desktopModal: false<br>}</code>        |
| disabled           | Same as native disabled                                                                                                                                                          | boolean                                                                                   | -                                                  | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                         |
| expanded           | Makes input full width when inside a grouped or addon field                                                                                                                      | boolean                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datetimepicker: {<br>&nbsp;&nbsp;expanded: false<br>}</code>            |
...
| mobileModal        | Overlay content is shown into a modal on mobile                                                                                                                                  | boolean                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datetimepicker: {<br>&nbsp;&nbsp;mobileModal: true<br>}</code>          |
| mobileNative       | Enable mobile native input if device is a mobile agent                                                                                                                           | boolean                                                                                   | -                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datetimepicker: {<br>&nbsp;&nbsp;mobileNative: true<br>}</code>         |
...
| position           | Position of the popover relative to the input                                                                                                                                    | "bottom" \| "center" \| "left" \| "right" \| "top"                                        | `auto`, `top`, `bottom`, `left`, `right`, `center` |                                                                                                                                                                     |
