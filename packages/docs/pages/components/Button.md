...
| icon      | Icon name to show on the left                                          | string                          | -                                                                               |                                                                                                                                                      |
...
| iconSize  | Size of the icon                                                       | string                          | `small`, `medium`, `large`                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>button: {<br>&nbsp;&nbsp;iconSize: undefined<br>}</code> |
