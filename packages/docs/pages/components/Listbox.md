...
The **Listbox** input component — similar to a select input — presents a list of options and allows a user to select one or more of them.
...
| checkable         | Enable a checkbox on the item element                                                                    | boolean                                          | -                                                 | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>listbox: {<br>&nbsp;&nbsp;checkable: false<br>}</code>             |
...
| options           | Listbox options, unnecessary when default slot is used                                                   | ListboxOptions&lt;unknown&gt;                    | -                                                 |                                                                                                                                                                |
...
| override       | Override existing theme classes completely                                                      | boolean                | -                                                 |                                                                                                                                                       |
| value          | Item value (it will be used as the v-model value of the wrapper component) - default is an uuid | string\|number\|object | -                                                 | <code style='white-space: nowrap; padding: 0;'>useId()</code>                                                                                         |
