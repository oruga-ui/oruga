...
<script setup>
import Base from "@/components/Timepicker/examples/base.vue";
import BaseCode from "@/components/Timepicker/examples/base.vue?raw";

import Inline from "@/components/Timepicker/examples/inline.vue";
import InlineCode from "@/components/Timepicker/examples/inline.vue?raw";

import MinMaxDate from "@/components/Timepicker/examples/min-max-date.vue";
import MinMaxDateCode from "@/components/Timepicker/examples/min-max-date.vue?raw";

import Templates from "@/components/Timepicker/examples/templates.vue";
import TemplatesCode from "@/components/Timepicker/examples/templates.vue?raw";

import Granularity from "@/components/Timepicker/examples/granularity.vue";
import GranularityCode from "@/components/Timepicker/examples/granularity.vue?raw";
</script>
