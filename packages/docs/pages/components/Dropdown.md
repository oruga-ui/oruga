...
| position          | Position of the dropdown relative to the trigger                                                                                                                                                                | PopoverPosition                      | `top`, `bottom`, `left`, `right`, `[top`, `right]`, `[top`, `left]`, `[bottom`, `left]`, `[bottom`, `right]` | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;position: "bottom"<br>}</code>          |
