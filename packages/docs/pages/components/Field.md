...
| block            | Show content in block style instead of multilines.                                                                                     | boolean            | -                                                                               |                                                                                                                                                             |
| grouped          | Direct child components/elements of Field will be grouped horizontally.                                                                | boolean            | -                                                                               | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                 |
...
| <s>multiline</s> | <div><b>deprecated</b> - will be the new default</div><div><s>Allow controls to fill up multiple lines, making it responsive</s></div> | boolean            | -                                                                               | <code style='white-space: nowrap; padding: 0;'>true</code>                                                                                                  |
