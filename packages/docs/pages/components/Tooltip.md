...
| <s>closeOnEscape</s>     | <div><b>deprecated</b> - will be removed</div><div><s>Close when pressing escape key</s></div>                                                                                   | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;closeOnEscape: false<br>}</code>     |
| <s>closeOnOutside</s>    | <div><b>deprecated</b> - will be removed</div><div><s>Close when clicked outside of the panel</s></div>                                                                          | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;closeOnOutside: false<br>}</code>    |
| <s>closeable</s>         | <div><b>deprecated</b> - will be removed</div><div><s>Close on hover out of the content</s></div>                                                                                | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;closeable: true<br>}</code>          |
...
| <s>openOnClick</s>       | <div><b>deprecated</b> - will be removed - use OPopover instead</div><div><s>Show when clicked on the trigger</s></div>                                                          | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;openOnClick: false<br>}</code>       |
| <s>openOnContextmenu</s> | <div><b>deprecated</b> - will be removed - use OPopover instead</div><div><s>Show when right clicked on the trigger</s></div>                                                    | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;openOnContextmenu: false<br>}</code> |
| <s>openOnFocus</s>       | <div><b>deprecated</b> - will be removed</div><div><s>Show when trigger get focused</s></div>                                                                                    | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;openOnFocus: false<br>}</code>       |
| <s>openOnHover</s>       | <div><b>deprecated</b> - will be removed</div><div><s>Show when hover over the trigger</s></div>                                                                                 | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;openOnHover: true<br>}</code>        |
...
| ------- | --------------------------------------------------- | ------------------------------------------- |
| default | Define a trigger here                               | **active** `boolean` - tooltip active state |
| content | Override the overlay content, default is label prop |                                             |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_tooltip.scss)
