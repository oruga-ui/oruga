...
The component is based on the [Dropdown](/components/Dropdown) component and implements the W3C ARIA APG [Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/).
It is implemented using the native [Popover API](https://developer.mozilla.org/en-US/docs/Web/API/Popover_API).
...
| debounce           | Number of milliseconds to delay before emitting the input event                                                                                                                  | number                                                                                       | -                                                 | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>autocomplete: {<br>&nbsp;&nbsp;debounce: 400<br>}</code>             |
...
| position           | Position of the dropdown relative to the input                                                                                                                                   | "bottom" \| "top"                                                                            | `top`, `bottom`                                   | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>autocomplete: {<br>&nbsp;&nbsp;position: "bottom"<br>}</code>        |
| rounded            | Makes the element rounded                                                                                                                                                        | boolean                                                                                      | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                      |
| selectOnClose      | Trigger the select event for focused option when dropdown got closed                                                                                                             | boolean                                                                                      | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                      |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_autocomplete.scss)
