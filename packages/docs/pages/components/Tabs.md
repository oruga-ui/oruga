...
_Tab panels_ are a set of individual content sections, where only one content panel can be displayed at a time.
...
| iconSize  | Icon size                                                                                 | string                                     | `small`, `medium`, `large`                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tabs: {<br>&nbsp;&nbsp;iconSize: undefined<br>}</code>  |
