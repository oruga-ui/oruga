...
| iconSize       | Size of the icon                                 | string  | `small`, `medium`, `large`                                                      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tag: {<br>&nbsp;&nbsp;iconSize: undefined<br>}</code>      |
...
See ➜ 📄 [SCSS file](https://github.com/oruga-ui/theme-tailwind/tree/main/src/assets/scss/components/_tag.scss)
