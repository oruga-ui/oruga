export type InspectData<T extends object = object, P extends object = object> = {
    [K in keyof Required<T>]: InspectClassDescription<T, K, P>;
};
export type InspectClassDescription<T = object, C extends keyof T = keyof T, P extends object = object> = {
    /** class name */
    class: C;
    /** class description */
    description: string;
