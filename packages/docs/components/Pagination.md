...
| <s>current</s>    | <div>Deprecated: will be renamed to `modelValue`</div><hr/><div><s>Current page number, use v-model:current to make it two-way binding</s></div> | number                          | -                                                 | <code style='white-space: nowrap; padding: 0;'>1</code>                                                                                                                 |
...
| <s>order</s>      | <div>Deprecated: will be renamed to `position`</div><hr/><div><s>Buttons order</s></div>                                                         | "centered" \| "left" \| "right" | `centered`, `right`, `left`                       | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>pagination: {<br>&nbsp;&nbsp;order: undefined<br>}</code>                   |
