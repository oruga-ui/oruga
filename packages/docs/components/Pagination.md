...
| <s> current </s>  | Current page number, use v-model:current to make it two-way binding - will be renamed to `modelValue` | number                          | -                                                 | <code style='white-space: nowrap; padding: 0;'>1</code>                                                                                                                 |
...
| <s> order </s>    | Buttons order - will be renamed to `position`                                                         | "centered" \| "left" \| "right" | `centered`, `right`, `left`                       | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>pagination: {<br>&nbsp;&nbsp;order: undefined<br>}</code>                   |
