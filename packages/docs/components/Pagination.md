...
| <s>current</s>    | <div><s>Current page number, use v-model:current to make it two-way binding</s></div><hr /><div><b>deprecated</b> - will be renamed to `modelValue`</div> | number                          | -                                                 | <code style='white-space: nowrap; padding: 0;'>1</code>                                                                                                                 |
...
| <s>order</s>      | <div><s>Buttons order</s></div><hr /><div><b>deprecated</b> - will be renamed to `position`</div>                                                         | "centered" \| "left" \| "right" | `centered`, `right`, `left`                       | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>pagination: {<br>&nbsp;&nbsp;order: undefined<br>}</code>                   |
