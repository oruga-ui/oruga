...
| <s>cancelable</s> | <div><b>deprecated</b> - use `closeOnOutside` and `closeOnEscape`</div><div><s>Is Loading cancelable by pressing escape or clicking outside</s></div>                                                                           | boolean | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                           |
