...
| <s>cancelable</s> | <div>Deprecated: use `closeOnOutside` and `closeOnEscape`</div><hr/><div><s>Is Loading cancelable by pressing escape or clicking outside</s></div>                                                                              | boolean | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                           |
