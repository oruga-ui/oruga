...
| <s> cancelable </s> | Is Loading cancelable by pressing escape or clicking outside - use `closeOnOutside` and `closeOnEscape`                                                                                                                         | boolean | -                                                 | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                           |
