...
| name      | Setting the same name to multiple elements connects them, with only one open at a time.<br/>This allows to easily create UI features such as accordions. | string            | -               |                                                                                                                                                      |
