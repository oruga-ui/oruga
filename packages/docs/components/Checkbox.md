...
| iconPack       | Icon pack to use                                                                     | string                         | `mdi`, `fa`, `fas and any other custom icon pack`                               | <div>From <b>config</b></div><br><code style='white-space: nowrap; padding: 0;'> checkbox: {<br>&nbsp;&nbsp;iconPack: undefined<br>}</code>  |
