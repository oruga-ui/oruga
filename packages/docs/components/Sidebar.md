...
| mobile           | Custom layout on mobile                                                                                                                                                             | "expanded" \| "reduced" \| "hidden"    | `expanded`, `reduced`, `hidden`      | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>sidebar: {<br>&nbsp;&nbsp;mobile: undefined<br>}</code>                |
