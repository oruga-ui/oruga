...
| container        | DOM element where the sidebar component will be created on (for programmatic usage).                                                                                                | string \| HTMLElement \| null | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>sidebar: {<br>&nbsp;&nbsp;container: "body"<br>}</code>                |
