...
| overlay                 |                                                                                                             | boolean        | -                                                                               |                                                                                     |
| position                | Skeleton position in relation to the window                                                                 | string         | `fixed`, `absolute`, `static`                                                   | () => { return getValueByPath(config, 'sidebar.position', 'fixed') }                |
...
| canCancel               | Sidebar cancel options                                                                                      | array\|boolean | `true`, `false`, `'escape'`, `'outside'`                                        | () => { return getValueByPath(config, 'sidebar.canCancel', ['escape', 'outside']) } |
