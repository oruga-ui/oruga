...
| position       | Tooltip position in relation to the element    | string         | `top`, `bottom`, `left`, `right`                                                | 'tooltip.position': 'top'     |
| triggers       | Tooltip trigger events                         | array          | `hover`, `click`, `focus`                                                       | 'tooltip.triggers': ['hover'] |
| always         | Tooltip will be always active                  | boolean        | -                                                                               |                               |
| animated       | Tooltip will have an animation                 | boolean        | -                                                                               | true                          |
| animation      | Tooltip default animation                      | string         | -                                                                               | 'tooltip.animation': 'fade'   |
