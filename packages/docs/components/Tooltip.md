...
| <s>closeable</s> | <div><s>Tooltip auto close options (pressing escape, clicking the content or outside)</s></div><hr /><div><b>deprecated</b> - will be only boolean - use `closeOnOutside` and `closeOnEscape` instead</div> | boolean \| ("content" \| "escape" \| "outside")[]                                                                | `true`, `false`, `content`, `outside`, `escape`                                                  | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;closeable: true<br>}</code>             |
...
| triggers         | Tooltip trigger events                                                                                                                                                                                      | ("focus" \| "click" \| "contextmenu" \| "hover")[]                                                               | `hover`, `click`, `focus`, `contextmenu`                                                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;triggers: ["hover","focus"]<br>}</code> |
