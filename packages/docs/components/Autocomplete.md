...
| useHtml5Validation  |                                                                                                                   | boolean        | -                                       | { "useHtml5Validation": true }       |
| statusIcon          |                                                                                                                   | boolean        | -                                       | { "statusIcon": true }               |
...
| animation           | Transition name to apply on dropdown list                                                                         | string         | -                                       | { 'autocomplete.animation': 'fade' } |
