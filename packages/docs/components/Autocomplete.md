...
| filter               | Function to filter the option based on the input value - default is label string comparison                                                                                      | ((option: string \| number \| object, value: string) =&gt; boolean)                                            | -                                                 |                                                                                                                                                                     |
...
| options              | Autocomplete options                                                                                                                                                             | OptionsPropWithGroups&lt;string \| number \| object&gt;                                                        | -                                                 |                                                                                                                                                                     |
