...
| openOnKeydown     | Show when the trigger has focus and a key is pressed                                                                                                                                                            | boolean                                                                                                          | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>tooltip: {<br>&nbsp;&nbsp;openOnKeydown: false<br>}</code>         |
...
| triggers          | Dropdown will be triggered by any events                                                                                                                                                                        | ("focus" \| "click" \| "contextmenu" \| "keydown" \| "hover")[]                                                  | `click`, `hover`, `contextmenu`, `focus`                                                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;triggers: []<br>}</code>                |
