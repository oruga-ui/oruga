...
| triggers         | Dropdown will be triggered by any events                                                                                                                                                                        | ("focus" \| "click" \| "contextmenu" \| "keydown" \| "hover")[]                                                  | `click`, `hover`, `contextmenu`, `focus`                                                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;triggers: ["click"]<br>}</code>         |
...
| ------- | -------------------------------------------------------------------------------------------- | -------- |
| trigger | Override the trigger element, default is label prop                                          |          |
| default | Place dropdown items here                                                                    |          |
| before  | Place extra `o-dropdown-item` components here, even if you have some options defined by prop |          |
| group   | Override the option group                                                                    |          |
| option  | Override the label, default is label prop                                                    |          |
