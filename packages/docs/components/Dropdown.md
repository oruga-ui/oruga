...
| default | Place dropdown items here                                                                    | **active** `boolean` - dropdown active state<br/>**focused-index** `number` - index of the focused element<br/>**toggle** `(): void` - toggle dropdown active state |
