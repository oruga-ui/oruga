...
| default | Place dropdown items here                                                                    | **active** `boolean` - dropdown active state<br/>**focusedIndex** `number` - index of the focused element<br/>**toggle** `(): void` - toggle dropdown active state |
