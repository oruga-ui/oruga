...
| stayOpen         | Disable close Dropdown when item selected                                                                                                                                        | boolean                                                                                                          | -                                                                                                | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                    |
...
| selected           | **value** `T` - selected value                 | on select event - fired before update:modelValue |
| change             | **value** `T \| T[]` - selected value          |
| open               | **method** `string` - open method              | on open event                                    |
