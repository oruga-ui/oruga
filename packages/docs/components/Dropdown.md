...
| disabled               |                                                                                                                                                        | boolean                                      | -                                      |                                                                              |
| hoverable              | Dropdown will be triggered by hover instead of click                                                                                                   | boolean                                      | -                                      |                                                                              |
...
| maxHeight              | Max height of dropdown content                                                                                                                         | string\|number                               | -                                      | () => {<br> return getValueByPath(config, 'dropdown.maxHeight', 200)<br>}    |
| position               | Optional, position of the dropdown relative to the trigger                                                                                             | string                                       | `top-right`, `top-left`, `bottom-left` |                                                                              |
| mobileModal            | Dropdown content (items) are shown into a modal on mobile                                                                                              | boolean                                      | -                                      | () => {<br> return getValueByPath(config, 'dropdown.mobileModal', true)<br>} |
...
| animation              | Custom animation (transition name)                                                                                                                     | string                                       | -                                      | () => {<br> return getValueByPath(config, 'dropdown.animation', 'fade')<br>} |
| multiple               | Allows multiple selections                                                                                                                             | boolean                                      | -                                      |                                                                              |
| trapFocus              | Trap focus inside the dropdown.                                                                                                                        | boolean                                      | -                                      | () => {<br> return getValueByPath(config, 'dropdown.trapFocus', true)<br>}   |
