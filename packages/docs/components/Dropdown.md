...
| multiple         | Allows multiple selections                                                                                                                                                       | IsMultiple              | -                                                                                                | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                                  |
...
| change            | **value** `[String, Number, Boolean, Object, Array]` - selected value          | on change event - fired after update:modelValue |
