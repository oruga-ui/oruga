...
| inline            | Menu content (items) are shown inline, trigger is removed                                                                                                                                                       | boolean                                                                                                          | -                                                                                                | <code style='white-space: nowrap; padding: 0;'>false</code>                                                                                                    |
...
| v-model           | The selected option value, use v-model to make it two-way binding                                                                                                                                               | unknown                                                                                                          | -                                                                                                |                                                                                                                                                                |
...
| triggers          | Dropdown will be triggered by any events                                                                                                                                                                        | ("focus" \| "click" \| "contextmenu" \| "hover")[]                                                               | `click`, `hover`, `contextmenu`, `focus`                                                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;triggers: []<br>}</code>                |
...
| before  | Define extra `o-dropdown-item` components here, even if you have some options defined by prop | **toggle** -                                                                                                                                                                |
...
| after   | Define extra `o-dropdown-item` components here, even if you have some options defined by prop | **toggle** -                                                                                                                                                                |
