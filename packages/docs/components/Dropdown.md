...
| position         | Position of the dropdown relative to the trigger                                                                                                                                 | "bottom" \| "auto" \| "top" \| "left" \| "right" \| "top-right" \| "top-left" \| "bottom-left" \| "bottom-right" | `auto`, `top`, `bottom`, `left`, `right`, `top-right`, `top-left`, `bottom-left`, `bottom-right` | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;position: "bottom-left"<br>}</code>                   |
...
| triggers         | Dropdown will be triggered by any events                                                                                                                                         | ("click" \| "hover" \| "focus" \| "contextmenu")[]                                                               | `click`, `hover`, `contextmenu`, `focus`                                                         | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>dropdown: {<br>&nbsp;&nbsp;triggers: ["click"]<br>}</code>                       |
