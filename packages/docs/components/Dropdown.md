...
| maxHeight              | Max height of dropdown content                                                                                                                         | string\|number                               | -                                      | 'dropdown.maxHeight': 200    |
| position               | Optional, position of the dropdown relative to the trigger                                                                                             | string                                       | `top-right`, `top-left`, `bottom-left` |                              |
| mobileModal            | Dropdown content (items) are shown into a modal on mobile                                                                                              | boolean                                      | -                                      | 'dropdown.mobileModal': true |
...
| animation              | Custom animation (transition name)                                                                                                                     | string                                       | -                                      | 'dropdown.animation': 'fade' |
| multiple               | Allows multiple selections                                                                                                                             | boolean                                      | -                                      |                              |
| trapFocus              | Trap focus inside the dropdown.                                                                                                                        | boolean                                      | -                                      | 'dropdown.trapFocus': true   |
