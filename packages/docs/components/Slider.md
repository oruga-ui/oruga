...
| locale            |                                                  | string\|array | -                                                                               | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> locale {<br>&nbsp;&nbsp;undefined : undefined<br>}</code> |
| max               | Maximum value                                    | number        | -                                                                               | 100                                                                                                                               |
| min               | Minimum value                                    | number        | -                                                                               | 0                                                                                                                                 |
| override          |                                                  | boolean       | -                                                                               |                                                                                                                                   |
| rounded           | Rounded thumb                                    | boolean       | -                                                                               | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> slider {<br>&nbsp;&nbsp;rounded' : false<br>}</code>      |
...
| variant           | Color of the slider                              | string        | `primary`, `info`, `success`, `warning`, `danger`, `and any other custom color` | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> slider {<br>&nbsp;&nbsp;variant' : 'primary'<br>}</code>  |
