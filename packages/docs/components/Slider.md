...
| customFormatter   | Function to format the tooltip label for display                      | Function                   | -                                                                               |                                                                                                                                                            |
...
| v-model           | The input value state                                                 | number \| [number, number] | -                                                                               | <code style='white-space: nowrap; padding: 0;'>0</code>                                                                                                    |
