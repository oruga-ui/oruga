...
The **Dialog** component is a flexible and extensible content container visualy based on a Card style.
Dialogs are built with as little markup and styles as possible, but still manage to deliver a ton of control and customization.
...
| position       | Text alignment in its entirety                                                                   | "centered" \| "left" \| "right" | -                                                                               |                                                                                                                                                           |
