...
| createItem         | Function to create a new item to push into v-model (items)                                                                                                                       | ((value: string \| number \| object) =&gt; string \| number \| object)                                         | -                                                                               | <code style='white-space: nowrap; padding: 0;'>item as T</code>                                                                                                     |
| customValidity     | Custom HTML 5 validation error to set on the form control                                                                                                                        | string \| ((currentValue: string \| number \| object \| null, state: ValidityState) =&gt; string) \| undefined | -                                                                               |                                                                                                                                                                     |
...
| filter             | Function to filter the options based on the input value - default is label string comparison                                                                                     | ((options: string \| number \| object, value: string) =&gt; boolean)                                           | -                                                                               |                                                                                                                                                                     |
...
| v-model            | The selected items, use v-model to make it two-way binding binding                                                                                                               | (string \| number \| object)[]                                                                                 | -                                                                               |                                                                                                                                                                     |
...
| options            | Taginput options                                                                                                                                                                 | OptionsPropWithGroups&lt;string \| number \| object&gt;                                                        | -                                                                               |                                                                                                                                                                     |
...
| validateItem       | Function to validate the value of a new item before it got added                                                                                                                 | ((value: string \| number \| object) =&gt; boolean)                                                            | -                                                                               | <code style='white-space: nowrap; padding: 0;'>true</code>                                                                                                          |
