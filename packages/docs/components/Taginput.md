...
| customValidity     | Custom HTML 5 validation error to set on the form control                                                                                                                        | string \| ((currentValue: (string \| object)[], state: ValidityState) =&gt; string) | -                                                                               | <code style='white-space: nowrap; padding: 0;'>""</code>                                                                                                            |
...
| validateItem       | Function to validate the value of a new item before it got added                                                                                                                 | (value: string \| object) =&gt; boolean                                             | -                                                                               | Default function (see source code)                                                                                                                                  |
