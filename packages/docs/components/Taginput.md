...
| createItem         | Function to create a new item to push into v-model (items)                                                                                                                       | (value: string) =&gt; T       | -                                                                               | Default function (see source code)                                                                                                                                  |
...
| field              | Property of the object (if data is array of objects) to use as display text                                                                                                      | string                        | -                                                                               |                                                                                                                                                                     |
