...
| dateFormatter             | Custom function to format a date into a string                                                                                                                                   | (date: Date \| Date[]) =&gt; string                                                                              | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;dateFormatter: () => undefined<br>}</code>    |
| dateParser                | Custom function to parse a string into a date                                                                                                                                    | (date: string) =&gt; Date \| Date[]                                                                              | -                                                                                                | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;dateParser: () => undefined<br>}</code>       |
...
| position                  | Position of the dropdown relative to the input                                                                                                                                   | "bottom" \| "auto" \| "top" \| "left" \| "right" \| "top-right" \| "top-left" \| "bottom-left" \| "bottom-right" | `auto`, `top`, `bottom`, `left`, `right`, `top-right`, `top-left`, `bottom-left`, `bottom-right` |                                                                                                                                                                        |
...
| selectableDates           | Define a list of dates which can be selected                                                                                                                                     | Date[] \| ((date: Date) =&gt; boolean)                                                                           | -                                                                                                | <code style='white-space: nowrap; padding: 0;'>[]</code>                                                                                                               |
...
| type                      | Define picker mode                                                                                                                                                               | "month" \| "date"                                                                                                | `date`, `month`                                                                                  | <code style='white-space: nowrap; padding: 0;'>"date"</code>                                                                                                           |
| unselectableDates         | Define a list of dates which can not be selected                                                                                                                                 | Date[] \| ((date: Date) =&gt; boolean)                                                                           | -                                                                                                | <code style='white-space: nowrap; padding: 0;'>[]</code>                                                                                                               |
