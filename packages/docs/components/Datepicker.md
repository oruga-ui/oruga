...
| position                  | Position of the dropdown relative to the input                                                                                                                                   | "left" \| "right" \| "auto" \| "top" \| "bottom" \| "top-right" \| "top-left" \| "bottom-left" \| "bottom-right"         | `auto`, `top`, `bottom`, `left`, `right`, `top-right`, `top-left`, `bottom-left`, `bottom-right` |                                                                                                                                                                        |
