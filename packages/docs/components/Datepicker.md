...
| mobileNative              | Enable mobile native input if mobile agent<br/>(Default will be switched to `false` in 0.9)                                                                                      | boolean                                | -                                                 | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>datepicker: {<br>&nbsp;&nbsp;mobileNative: true<br>}</code>                |
