...
| v-model                   | The input value state                                                                                                                                                            | Date \| Date[]                                 | -                                                                                                |                                                                                                                                                                        |
...
| position                  | Position of the dropdown relative to the input                                                                                                                                   | string                                         | `auto`, `top`, `bottom`, `left`, `right`, `top-right`, `top-left`, `bottom-left`, `bottom-right` |                                                                                                                                                                        |
