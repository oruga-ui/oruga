...
| debounce           | Number of milliseconds to delay before the value get emitted                              | number                                                                                                | -                                                                               | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>autocomplete: {<br>&nbsp;&nbsp;debounce: 300<br>}</code>      |
