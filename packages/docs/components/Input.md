...
| hasCounter         | Show character counter when maxlength prop is passed        | boolean             | -                                                 | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> input {<br>&nbsp;&nbsp;counter' : false<br>}</code>                |
...
| statusIcon         | Show status icon using field and variant prop               | boolean             | -                                                 | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> "statusIcon" {<br>&nbsp;&nbsp;undefined : true<br>}</code>         |
| type               | Input type, like native                                     | string              | `Any native input type`, `and textarea`           | 'text'                                                                                                                                     |
| useHtml5Validation | Enable html 5 native validation                             | boolean             | -                                                 | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> "useHtml5Validation" {<br>&nbsp;&nbsp;undefined : true<br>}</code> |
