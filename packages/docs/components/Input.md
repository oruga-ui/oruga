...
| customValidity     | Custom HTML 5 validation error to set on the form control      | string \| ((currentValue: string, state: ValidityState) =&gt; string) (`currentValue` is `number` if the `number` prop is `true`.) | -                                                                               |                                                                                                                                                           |
