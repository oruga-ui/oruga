...
| iconPrev                      | Icon to use for navigation button                                                                                             | string         | -                                                                               | 'steps.iconPrev': 'chevron-left'  |
| iconNext                      | Icon to use for navigation button                                                                                             | string         | -                                                                               | 'steps.iconNext': 'chevron-right' |
