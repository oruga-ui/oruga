...
| timeFormatter         |                                                                    | func           | -                                                 | <div>From <b>config</b></div><br><code style='white-space: nowrap; padding: 0;'>{<br>&nbsp;&nbsp; vm: undefined<br>}</code>                 |
| timeParser            |                                                                    | func           | -                                                 | <div>From <b>config</b></div><br><code style='white-space: nowrap; padding: 0;'>{<br>&nbsp;&nbsp; vm: undefined<br>}</code>                 |
