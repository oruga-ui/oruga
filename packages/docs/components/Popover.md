...
| behavior  | The behavior of the popover.                                                                                                                                                     | "auto" \| "hint" \| "manuell" | -                                                                                                | <code style='white-space: nowrap; padding: 0;'>"auto"</code>                                                                                        |
...
| position  | The position of the popover relative to the trigger                                                                                                                              | PopoverPosition               | `auto`, `top`, `bottom`, `left`, `right`, `top-right`, `top-left`, `bottom-left`, `bottom-right` | <div><small>From <b>config</b>:</small></div><code style='white-space: nowrap; padding: 0;'>popover: {<br>&nbsp;&nbsp;position: "top"<br>}</code>   |
