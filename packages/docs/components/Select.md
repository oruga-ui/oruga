...
| iconRight          | Icon name to be added on the right side                     | string                                 | -                                                 | <div><b>Config</b></div><code style='white-space: nowrap; padding: 0;'> select {<br>&nbsp;&nbsp;iconRight' : 'caret-down'<br>}</code>      |
