...
| customValidity     | Custom HTML 5 validation error to set on the form control                             | string \| ((currentValue: string \| number \| object \| (string \| number \| object)[] \| null, state: ValidityState) =&gt; string) \| undefined | -                                                                               | <code style='white-space: nowrap; padding: 0;'></code>                                                                                                |
...
| v-model            | The input value state                                                                 | string \| number \| object \| (string \| number \| object)[]                                                                                     | -                                                                               |                                                                                                                                                       |
...
| options            | Select options, unnecessary when default slot is used                                 | OptionsPropWithGroups&lt;string \| number \| object&gt;                                                                                          | -                                                                               |                                                                                                                                                       |
