...
<template>
  ...
  <p>
    Use the <code>min-date</code> and <code>max-date</code> props to define
    a limited date range for the user to choose from.
  </p>
  <ExampleViewer
    :component="MinMaxDate"
    :code="MinMaxDateCode" />
  ...
  <p>
    Let the user select a date range by setting the
    <code>range</code> prop.
  </p>
  <ExampleViewer
    :component="Range"
    :code="RangeCode" />
  ...
  <p>
    When the <code>multiple</code> prop is set, the user can select multiple
    dates at once. Also, the <code>modelValue</code> prop will be an array
    of date objects instead of a single date object.
  </p>
  <ExampleViewer
    :component="Multiple"
    :code="MultipleCode" />
  ...
  <p>
    The calendar can display indicators for events on specific dates by
    passing a list to the <code>events</code> prop.
  </p>
  <ExampleViewer
    :component="Events"
    :code="EventsCode" />
  ...
  <h3 id="programmatically">
    Programmatically
  </h3>
  <p>
    The dorpdown/modal can be opened programmatically setting the
    <code>active</code> prop, which is also two-way bindable.
  </p>
  <ExampleViewer
  ...
  <p>
    Instead of picking a full date by setting the <code>type</code> prop to
    "month", the component will only render a month selector.
  </p>
  <ExampleViewer
