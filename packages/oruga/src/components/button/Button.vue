    ...
    computed: {
        rootClasses() {
            return [
                ...
                { [`${this.computedClass('button', 'outlinedClass', 'o-btn--outlined-', true)}${this.variant}`]: this.outlined && this.variant },
                { [`${this.computedClass('button', 'invertedClass', 'o-btn--inverted-', true)}${this.variant}`]: this.inverted && this.variant },
