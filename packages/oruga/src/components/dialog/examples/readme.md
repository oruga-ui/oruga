The **Dialog** component is a flexible and extensible content container overlaid on either the primary window or another dialog. 
It used to create both modal and non-modal dialog boxes. 
