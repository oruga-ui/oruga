...
<template>
    <div class="vp-doc">
        <h3 id="base">Base</h3>
        <p>
            The sidebar can be positioned go appear from each side of the
            viewport using the <code>position</code> prop. Using
            <code>fullwidht</code> or <code>fullheight</code>, the sidebar
            overlaps the entire viewport width or height.
        </p>
        ...
        <p>
            The <code>teleport</code> prop allows the sidebar to be "teleported"
            into any DOM node outside the DOM hierarchy of that component. By
            default, if only a boolean is passed, the sidebar will be teleported
            to the document body. In addition, any other destination can be
            passed as a value to the <code>teleport</code> prop.
        </p>
        ...
        <p>
            ...
            inside the sidebar. Furthermore, an inline component created with a
            <a href="https://vuejs.org/guide/extras/render-function.html">
                render function
            </a>
            can also be passed. Props and events can be passed to the component
            with <code>props</code> and <code>events</code> props too.
        </p>
