...
> = {
  ...
  stickyHeaderClass: {
    ...
    description: "Class of the table wrapper element when header is sticky.",
  ...
  scrollableClass: {
    ...
    description: "Class of the table wrapper element when its content is scrollable.",
  ...
  thCurrentSortClass: {
    ...
    description: "Class of the table `th` element that is currently sorted.",
  ...
  trCheckedClass: {
    ...
    description: "Class of the table `tr` element when checkable and checked.",
    info: "Select a row of the table to see it in action!",
    properties: ["checkable"],
    action: (data): void => {
      data.checkable = true;
  ...
  tdDetailClass: {
    class: "tdDetailClass",
    description: "Class of the table `td` element of the detail column of triggers.",
    properties: ["detailed"],
    action: (data): void => {
      data.detailed = true;
    },
