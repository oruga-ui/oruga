...
<template>
    ...
    <p>
        ...
        possible to mix both approaches by adding a <code>columns</code> prop as
        well as passing <code>&lt;o-table-column&gt;</code> components in the
    ...
    <p>
        ...
        <code>selected</code> prop represents the currently selected element.
        The prop is two-way bindable.Consider defining whether a row is
        selectable with a function given by the
    ...
    <p>
        ...
        <code>keep-checked-on-page-change</code> prop. Consider defining whether
    ...
    <p>
        ...
        bindable. By default, the detail is displayed as another tr, but adding
        <code>custom-detail-row</code> removes the tr wrapper from the provided
        <code>detail</code> slot. Consider defining whether a row can have a
        detail section with a function given by the
    ...
    <p>
        ...
        <a href="/components/Pagination.html">pagination</a> component when the
        <code>paginated</code> prop is set. The <code>per-page</code> prop can
        be used to specify the number of rows per page. Any property prefixed
        with "pagination" is passed to the pagination component.
    ...
    <p>
        ...
        handling the events. Each functionality fires an event that can be used
        to update the <code>data</code>. A loading state can also be enabled by
        using the <code>loading</code> prop.
    </p>
    <ExampleViewer :component="AsyncData" :code="AsyncDataCode" />

    <h3 id="sticky">Sticky</h3>
    <p>
        Adding the <code>sticky-header</code> prop to the Table component makes
        the header stick to the top when scrolling vertically. Adding the
        <code>sticky</code> prop to individual TableColumn components makes the
        column stick to the left when scrolling horizontally.
    </p>
