...
> = {
  ...
  positionClass: {
    class: "positionClass",
    description: "Class of the root element when is vertical and has position.",
  ...
  stepVariantClass: {
    ...
    subitem: "stepitem",
    description: "Class of the step item element with variant (default value by parent steps component).",
    properties: ["variant"],
